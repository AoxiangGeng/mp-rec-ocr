...
struct AdOperation{
    ...
    2:AD ad,  //广告信息
    3:string impid //曝光id
    4:i32 view_time, //曝光时间
    5:string view_ip,  //展示ip
    6:i32 click_time, //点击时间
    7:string click_ip, //点击ip
    8:i16 cost_type, //计费类型
    9:optional i16 click_type, //点击类型
    10:optional i16 click_info, //点击详情
    11:optional Behavior behavior, //点击操作行为数据
}
