...
from pytools.program.python import str_to_unicode
...
def pformat_duration(seconds, en_name=True):
    u'''
    >>> pformat_duration(.1, en_name=False) == u'0.1秒'
    True
    >>> pformat_duration(30.1, en_name=False) == u'30秒'
    True
    >>> pformat_duration(90, en_name=False) == u'1.5分钟'
    True
    >>> pformat_duration(125, en_name=False) == u'2分钟'
    True
    >>> pformat_duration(125, en_name=True)
    u'2m'
    >>> pformat_duration(7200.1, en_name=False) == u'2小时'
    True
